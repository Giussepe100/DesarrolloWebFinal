...
<!DOCTYPE html>
<html lang="es-ES" data-website-id="1" data-main-object="website.page(8,)" data-oe-company-name="AQPExpressParts"
...
<head>
  ...
  <meta property="og:title" content="Privacy Policy | AQPExpressParts" />
  <meta property="og:site_name" content="AQPExpressParts" />
  <meta property="og:url" content="privacy.html" />
  <meta property="og:image" content="web/image/website/1/logoe5a0.jpg?unique=17ff01e" />

  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Privacy Policy | AQPExpressParts" />
  ...
  <title> Fundas | AQPExpressParts </title>
  <link type="image/x-icon" rel="shortcut icon" href="../images/icon.ico" />
  <link rel="preload" href="web/static/lib/fontawesome/fonts/fontawesome-webfont3e6e.woff2?v=4.7.0" as="font"
    crossorigin="" />
  ...
  <link rel="stylesheet" href="../css/admin/categAcces.css">

  <script id="web.layout.odooscript" type="text/javascript">
    var odoo = {
      csrf_token: "ac557e077030d85e4b1864409f9a20f2490517feo1694794364",
      debug: "",
    };
  </script>
...
<body class="">
	...
	List<Producto> lst = bo.consultarFundas();
	%>
          ...
          <div id="top_menu_collapse" class="collapse navbar-collapse order-last order-lg-0">
            <ul id="top_menu" class="barra">
              ...
              <li class="nav-item ml-lg-auto o_no_autohide_item">
                <a href="web/login.html" class="nav-link font-weight-bold" style="color: black;">Identificarse</a>
              </li>
        ...
        <div class="oe_structure">
          <section class="s_title parallax s_parallax_is_fixed bg-black-50 pt24 pb24" data-vcss="001"
            ...
            <span class="s_parallax_bg oe_img_bg"
              style="background-image: url(%27/web/image/website.html); background-position: 50% 0;"></span>
            <div class="o_we_bg_filter bg-black-50"></div>
            <div class="container">
              <h3>Seccion de: Fundas</h3>
            </div>
          </section>
        </div>
      ...
      <div class="container bootstrap snipets">
        <div class="row flow-offset-1">
          ...
          <div class="col-xs-6 col-md-4" style="padding: 20px">
            <div class="product tumbnail thumbnail-3"><a href="#"><img src="../images/productos/<%=prod.getImagen()%>" alt="" height="250"
                  width="350" /></a>
              <div class="caption">
                <h6><br><a href="#"><%=prod.getNombreProducto()%></a></h6>
                <span class="price sale">S/. <%=prod.getCosto()%></span>
              </div>
            </div>
          </div>
		  <%
		  ...
		  %>
		<!--  EJEMPLO COLOCAR PRECIO CON DESCUENTO
          <div class="col-xs-6 col-md-4">
            <div class="product tumbnail thumbnail-3"><a href="#"><img src="fundas\funda_kia.jpg" alt="" height="250"
                  width="350" /></a>
              <div class="caption">
                <h6><a href="#">funda vehiculo</a></h6><span class="price">
              ...
              <div class="row">
                ...
                <div id="connect" class="col-lg-4 offset-lg-1 pt24 pb24 o_colored_level">
                  ...
                  <div class="s_social_media text-left o_not_editable" data-snippet="s_social_media"
                    ...
                    <a href="website/social/linkedin.html" class="s_social_media_linkedin" target="_blank">
                      <i class="fa fa-linkedin rounded-circle shadow-sm"></i>
                    </a>
                    <a href="website/social/instagram.html" class="s_social_media_instagram d-none" target="_blank">
                      <i class="fa fa-instagram rounded-circle shadow-sm"></i>
                    </a>
                    <a href="website/social/youtube.html" class="s_social_media_youtube d-none" target="_blank">
                      <i class="fa fa-youtube rounded-circle shadow-sm"></i>
                    </a>
                    <a href="website/social/github.html" class="s_social_media_github d-none" target="_blank">
