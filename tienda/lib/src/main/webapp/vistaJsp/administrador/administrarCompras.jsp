...
<head>
  ...
  <title> Administrar Compras | AQPExpressParts </title>
...
<body class="">
	<%@ page import="tienda.proc.testJsp.BOGestionCompraProducto"%>
	<%@ page import="java.util.List"%>
	<%@ page import="tienda.entidades.jdbc.*"%>
	<%
	BOGestionCompraProducto bo = new BOGestionCompraProducto();
	List<CompraProducto> lst = bo.consultarCompraProductos();
	%>
          ...
          <div id="top_menu_collapse" class="collapse navbar-collapse order-last order-lg-0">
            <ul id="top_menu" class="barra">
              ...
              <li class="nav-item ml-lg-auto o_no_autohide_item">
                <a href="../login.jsp" class="nav-link font-weight-bold" style="color: black;">Identificarse</a>
              </li>
      ...
      <div id="wrap">
		...
		<div class="tablas">
			<table>
				...
				<%
		        for (CompraProducto compProd : lst) {
		        %>
				<tr>
					<td><%=compProd.getId()%></td>
					<td><%=compProd.getNomUsuario()%></td>
					<td><%=compProd.getApeUsuario()%></td>
					<td><%=compProd.getNomProd()%></td>
					<td><%=compProd.getCantProd()%></td>
					<td>S/ <%=compProd.getSubtotalProd()%></td>
				</tr>
				<%
		        }
		        %>
			...
			<div class="ubicacion">
				<a href="administrarWeb.jsp" class="pricing-button return">Volver</a>
			</div>
		</div>
      </div>
            ...
            <div class="row">
              ...
              <div id="connect" class="col-lg-4 offset-lg-1 pt24 pb24 o_colored_level">
                ...
                <div class="s_social_media text-left o_not_editable" data-snippet="s_social_media"
                  ...
                  <a href="index.html" class="text-800">
